...
public class VolunteerDto  implements Serializable {
    ...
    private final Long runningNumberСount; //колчиство забегов в качестве волонтера
    private List<String> positionNameHistory; //исторический список позиций волонтера

    public VolunteerDto(Integer id, Integer userId, Instant runningDate, Integer runningNumber, String positionName, String positionDescription, String teamsName, Integer teamsId, Long runningNumberСount) {
        this.id = id;
        this.userId = userId;
        ...
        this.runningNumberСount = runningNumberСount;
    }

    public VolunteerDto(Integer id, Integer userId, Instant runningDate, Integer runningNumber, String positionName, String positionDescription, String teamsName, Integer teamsId, Long runningNumberСount, List<String> positionNameHistory) {
        this.id = id;
        this.userId = userId;
        this.runningDate = runningDate;
        this.runningNumber = runningNumber;
